...
export default function CreateListing() {
    ...
    useEffect(() => {
        const fetchListing = async () => {
            ...
            const res = await axios.get(`${BACKEND_URL}/api/listing/get/${listingId}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await axios.post(`${BACKEND_URL}/api/listing/update/${params.id}`, body);
            const data = await res.data;
            setLoading(false);
            if (data.success === false) {
                ...
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <div className='flex gap-6 flex-wrap'>
                        ...
                        <div className='flex gap-2'>
                            ...
                            <label
                            htmlFor='offer'
                            className={`inline-block px-3 py-1 rounded-full cursor-pointer ${formData.offer ? 'bg-green-800 text-white' : 'bg-gray-200 text-gray-700'
                                }`}
                        >
                            Offer
                        </label>
